...
export default function App(){
 ...
 const deleteOrder=async id=>{const previous=orders;setOrders(items=>items.filter(order=>order.id!==id));const{error}=await deleteStoredOrder(id);if(error){setOrders(previous);window.alert(`No se pudo eliminar el pedido: ${error.message}`);return false}return true};
